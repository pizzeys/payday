  ...
  class PdfRenderer
    ...
    def self.totals_lines(invoice, pdf)
      ...
      if invoice.tax2_rate > 0
        if invoice.tax2_description.nil?
          tax2_description = I18n.t("payday.invoice.tax", default: "Tax 2:")
        else
          tax2_description = invoice.tax2_description
        end

        table_data << [
          bold_cell(pdf, tax2_description),
